...
```js
 {
   ...
   entities: {
     ...
     posts: {
       ...
       100: {
         id: 100,
         title: 'Creating a Simple Application Using React JS and Flux rchitecture',
         author: 2
       }
     }
   },
...
In this guide, we won't normalize entities, but it's something you should consider or a more dynamic application.
## Handling Actions
